...
?>
Rev0lve est un jeu vidéo pour PC que j'ai réalisé en solo dans mon temps libre, en approximativement 5 mois. Il se trouve actuellement dans un
...
Le jeu a été réalisé avec Unity, en 2D, basé sur le concept original de contrôler le niveau au lieu du personnage.
Tous les sprites sont dessinés en pixel art par moi-même, et les scripts sont écrits à la main. Voici un des niveaux :
